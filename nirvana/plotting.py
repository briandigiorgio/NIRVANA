...
def summaryplot(f, plate=None, ifu=None, smearing=True, stellar=False, maxr=None, mix=False, cen=True, auto=True):
    '''
    ...
    Args:
        ...
        auto (:obj:`bool`, optional):
            Flag for automatically setting arguments if `f` is a file generated
            by the `nirvana.scripts.nirvana` automatic outfile naming. Will
            override any other values that have been supplied.
